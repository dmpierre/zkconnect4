      ...
      <div className="flex justify-center">
        <div className="flex flex-col pt-5 basis-60 md:basis-96">
          ...
          <div className={`px-2 py-2 text-center ${urbanist.className}`}>
            <Info text={"You will play against an RL connect4 trained agent (~76% win rate against a random playing strategy, not too bad but don't expect too much) and generate a snark to prove your game using nova."}></Info>
          </div>
          <br />
